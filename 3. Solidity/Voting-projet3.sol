...
contract Voting is Ownable {
    ...
    /// @param Index of the proposal in the table
    ...
    /// @param voter's address to add in the whitelist
	...
	/// @dev Function can only be called by a registered voter	
    /// @Custom patch fot evicting a DoS Gas Limit
    function setVote(uint256 _id) external onlyVoters {
        ...
        /// @Dev To evict a DoS Gas Limit in tallyVotes - Identify the winning proposal
    ...
    /// @Dev The commented code is done for preventing a DOS gaz limit attack. The count of the votes is done in setVote function. Function can only be called by the deployer of the contract
